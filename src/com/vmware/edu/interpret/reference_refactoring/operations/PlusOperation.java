...
/**
 * This class implements Operation interface and provide the logic of plus
...
public class PlusOperation implements Operation {
	...
	/**
	 * @param cmdargs
	 *            - String of all parameters after the command calc.
	 ...
	 *            summation of the two variables.
	 * @param newValue
	 ...
	 * @return String - the result of execution of the summation.
	 */
	private String plus(String cmdargs) {
		String[] args = cmdargs.split(" ");
		String newValue = CmdInterpreter.variables.get(args[1]).calcPlus(CmdInterpreter.variables.get(args[3]));
